...
import { Row, Col, Card, CardDeck, ListGroup, ListGroupItem } from 'react-bootstrap';
...
export const Home = () => {
            ...
            <Col md={3}>
                <Card key={uuid}>
                    ...
                    <Card.Body className="align-items-center">
                        ...
                        <Card.Text><a href={twitterLink} target="_blank"><FaTwitterSquare /> @{username} <GoLinkExternal /></a></Card.Text>
                    </Card.Body>
                </Card>
            </Col>
    ...
    <React.Fragment>
        {/* <Row>
            ...
            <Col>
                <p className="description">This year’s conference features a mix of panels and talks set against the backdrop of beautiful Lake Las Vegas. In addition to a can’t-miss schedule, we’re organizing off-hour activities providing opportunities for relaxation, adventure, and getting to other React enthusiasts.</p>
            </Col>
        </Row> */}
        <Row className="mb-4">
