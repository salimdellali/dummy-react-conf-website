			...
			<Container>
				<Row className="mb-4 align-items-md-center">
					<Col md={4}>
						...
						<p>
							Just northeast of Henderson, NV, the luxurious Westin is a hidden
							oasis with breathtaking views. Your visit is sure to be memorable.
						</p>
					</Col>
					<Col md={8}>
						<Carousel>
							<Carousel.Item>
								<img className="d-block w-100" src={venueImg} alt="The Venue" />
								<Carousel.Caption>
									<h3>The Venue</h3>
							...
							<Carousel.Item>
								<img className="d-block w-100" src={hallImg} alt="The Hall" />
